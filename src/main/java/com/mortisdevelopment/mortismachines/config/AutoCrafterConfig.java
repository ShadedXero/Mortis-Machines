...
import com.mortisdevelopment.mortismachines.machines.autocrafter.*;
import com.mortisdevelopment.mortismachines.menu.MenuItems;
import com.mortisdevelopment.mortismachines.recipes.MaxRecipe;
import com.mortisdevelopment.mortismachines.recipes.RecipeCategory;
...
public class AutoCrafterConfig {
    ...
    private void loadConfig() {
        ...
        configManager.getManager().setAutoCrafterManager(new AutoCrafterManager(configManager.getManager().getDataManager(), menuItems, progressMenuItems, recipeMenuItems));
