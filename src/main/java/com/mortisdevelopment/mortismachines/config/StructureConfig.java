...
import com.mortisdevelopment.mortismachines.structures.StructureBlock;
import com.mortisdevelopment.mortismachines.structures.StructureManager;
import com.mortisdevelopment.mortismachines.structures.Vector;
...
public class StructureConfig {
    ...
    public StructureConfig(ConfigManager configManager) {
    ...
    public void saveStructure(Structure structure) {
        ...
        if (core.getKeys() != null && core.getKeys().size() != 0) {
            coreSection.set("keys", core.getKeys());
        }
        for (StructureBlock structureBlock : structure.getBlocks()) {
            ...
            if (structureBlock.getKeys() != null && structureBlock.getKeys().size() != 0) {
                blockSection.set("keys", structureBlock.getKeys());
            }
        }
        try {
            config.save(file);
