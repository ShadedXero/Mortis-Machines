...
import com.mortisdevelopment.mortismachines.machines.idcard.IdCardMachine;
...
public class IdCardConfig {
    ...
    private void loadMenu(ConfigurationSection menu) {
        ...
        configManager.getManager().setIdCardManager(new IdCardManager(configManager.getManager().getDataManager(), menuItems));
    }
