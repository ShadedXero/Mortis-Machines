    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (args[0].equalsIgnoreCase("give")) {
            ...
            if (args[1].equalsIgnoreCase("item")) {
                ...
                ItemStack item = manager.getItemManager().getItem(args[3]);
                if (item == null) {
            ...
            if (args[1].equalsIgnoreCase("block")) {
                ...
                if (customBlock == null) {
                    MessageUtils utils = new MessageUtils("&cPlease enter a valid block id");
                    utils.color();
                    sender.sendMessage(utils.getMessage());
                    return false;
                }
                customBlock.giveCustomBlock(target);
                MessageUtils utils = new MessageUtils("&cBlock Given");
                utils.color();
                sender.sendMessage(utils.getMessage());
            }
        }
