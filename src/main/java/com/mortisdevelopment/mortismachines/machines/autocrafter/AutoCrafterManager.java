...
public class AutoCrafterManager extends Manager {
    ...
    public AutoCrafterManager(DataManager dataManager, MenuItems menuItems, MenuItems progressMenuItems, MenuItems recipeMenuItems) {
        super(MachineType.AUTO_CRAFTER, dataManager,false, false);
