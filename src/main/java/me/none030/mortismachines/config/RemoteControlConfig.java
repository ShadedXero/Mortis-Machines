...
import me.none030.mortismachines.machines.remotecontrol.remotes.*;
...
public class RemoteControlConfig {
    ...
    private void loadConfig() {
        ...
        DataConfig data = new DataConfig(MachineType.REMOTE_CONTROL);
        data.load(configManager.getManager().getRemoteControlManager());
    }
    ...
    private void loadMenu(ConfigurationSection menu) {
        ...
        configManager.getManager().setRemoteControlManager(new RemoteControlManager(menuItems));
    }
