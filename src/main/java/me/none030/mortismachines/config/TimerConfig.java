...
import me.none030.mortismachines.machines.timer.TimerMachine;
...
public class TimerConfig {
    ...
    private void loadConfig() {
        ...
        configManager.getManager().setTimerManager(new TimerManager(menu));
        loadMachine(section.getConfigurationSection("machine"));
        loadMessages(section.getConfigurationSection("messages"));
        DataConfig data = new DataConfig(MachineType.TIMER);
        data.load(configManager.getManager().getTimerManager());
    }
